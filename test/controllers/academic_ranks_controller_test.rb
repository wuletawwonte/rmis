...
class AcademicRanksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create academic_rank" do
    assert_difference("AcademicRank.count") do
      post academic_ranks_url, params: { academic_rank: { name: @academic_rank.name, order_key: @academic_rank.order_key } }
    end
  ...
  test "should update academic_rank" do
    patch academic_rank_url(@academic_rank), params: { academic_rank: { name: @academic_rank.name, order_key: @academic_rank.order_key } }
