...
class ResearchTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create research_type" do
    assert_difference("ResearchType.count") do
      post research_types_url, params: { research_type: { allowed_per_year: @research_type.allowed_per_year, fund: @research_type.fund, gender: @research_type.gender, name: @research_type.name, theme_based: @research_type.theme_based } }
    end
  ...
  test "should update research_type" do
    patch research_type_url(@research_type), params: { research_type: { allowed_per_year: @research_type.allowed_per_year, fund: @research_type.fund, gender: @research_type.gender, name: @research_type.name, theme_based: @research_type.theme_based } }
