...
class EducationLevelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create education_level" do
    assert_difference("EducationLevel.count") do
      post education_levels_url, params: { education_level: { name: @education_level.name, order_key: @education_level.order_key } }
    end
  ...
  test "should update education_level" do
    patch education_level_url(@education_level), params: { education_level: { name: @education_level.name, order_key: @education_level.order_key } }
