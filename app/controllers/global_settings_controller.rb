class GlobalSettingsController < ApplicationController
  before_action :set_global_setting, only: %i[ index edit update ]
  ...
  private
    ...
    def global_setting_params
      params.require(:global_setting).permit(:university_name, :university_email, :university_phone, :university_city, :university_country, :allowed_pi_per_year, :allowed_co_per_year, :date_format, :default_password, :minimum_password_length, :university_website, :university_facebook, :university_twitter, :university_telegram)
    end
end
